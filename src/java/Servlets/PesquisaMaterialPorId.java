 ...
 * @author LAB03-22
 */
@WebServlet(name = "PesquisaMaterialPorId", urlPatterns = {"/pesquisaMaterialporid"})
public class PesquisaMaterialPorId extends HttpServlet {
...
//        processRequest(request, response);
        ...
        int idMaterial = Integer.valueOf(request.getParameter("id"));

 ...
 * @author LAB03-22
 */
@WebServlet(name = "PesquisaFornecedorPorId", urlPatterns = {"/pesquisafornecedorporid"})
public class PesquisaFornecedorPorId extends HttpServlet {
...
//        processRequest(request, response);
        ...
        int idFornecedor = Integer.valueOf(request.getParameter("id"));
        ...
        dispatcher = request.getRequestDispatcher("detalheFornecedor.jsp");

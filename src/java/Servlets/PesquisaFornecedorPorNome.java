 ...
 * @author Qualidade
 */
@WebServlet(name = "PesquisaFornecedorPorNome", urlPatterns = {"/pesquisaFornecedorPorNome"})
public class PesquisaFornecedorPorNome extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //processRequest(request, response);
            if (("".equals(request.getParameter("codigo")))&&(!"".equals(request.getParameter("nome")))){   
                    ...
                    List<Fornecedor> fornecedores = fornecedorDao.findByNome(nomeFornecedor);
        
                    request.setAttribute("fornecedor", fornecedores);
                    RequestDispatcher dispatcher;
                    dispatcher = request.getRequestDispatcher("PesquisaFornecedorPorNome.jsp");
                    dispatcher.forward(request, response);
            }
            if ((!"".equals(request.getParameter("codigo")))&&("".equals(request.getParameter("nome")))){
                int cod = Integer.valueOf(request.getParameter("codigo"));
                 response.sendRedirect("pesquisafornecedorporid?id="+cod);

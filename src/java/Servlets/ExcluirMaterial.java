 ...
 * @author Qualidade
 */
@WebServlet(name = "ExcluirMaterial", urlPatterns = {"/excluirMaterial"})
public class ExcluirMaterial extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //processRequest(request, response);
            ...
            Material material = new Material();//cria o objeto         
            material.setId(Integer.valueOf(request.getParameter("id"))); 
            MaterialImpl materialDao = new MaterialImpl();//cria o objeto contatoDao
            ...
            response.sendRedirect("listarMaterial.jsp");
